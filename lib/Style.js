...
var fill = function(wb,opts){
	...
	if(opts.fgColor){
		this.fgColor=cleanColor(opts.fgColor);
	}
	if(opts.bgColor){
		this.bgColor=cleanColor(opts.bgColor);
	}
	this.generateXMLObj=genXMLObj;
...
exports.Style = function(opts){
	...
	if(this.styleData.fills.length == 0){
		var defaultFill = new fill(this,{patternType:'none'});
		var defaultFill2 = new fill(this,{patternType:'gray125'});
	}
