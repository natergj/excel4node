...
var style = function(wb,opts){
	...
	function fontFunctions(){
		...
		function setFontOptions(opts){
			Object.keys(opts).e4nForEach(function(o){
				curFont[o]=opts[o];
			});
	...
	function cloneStyle(){
		...
		Object.keys(newStyle.xf).e4nForEach(function(k){
...
exports.border = function(wb,opts){
	...
	ordinals.e4nForEach(function(o){
		if(this && this[o]){
...
exports.getStyleById = function(wb,id) {
	var xf = undefined;
	wb.styleData.cellXfs.e4nForEach(function(s){
		if(s.xfId==id){
			xf = s;
		}
	});
