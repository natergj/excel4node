...
exports.WorkBook.prototype.Style = style.Style;
exports.WorkBook.prototype.createStyleSheetXML = function(){
	var data={
			styleSheet:{
				'@xmlns':'http://schemas.openxmlformats.org/spreadsheetml/2006/main',
				'@mc:Ignorable':'x14ac',
	...
	return styleXML.end(xmlDebugVars);
}

exports.WorkBook.prototype.getStringIndex = function(val){
